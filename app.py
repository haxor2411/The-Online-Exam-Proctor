...
db = pymysql.connect(host="localhost", user="root", password="root", database="examproctordb", port=3306)

# api = Api(app)
# app.config['MYSQL_HOST'] = 'mysql://root:root@localhost:3306/examproctordb'
