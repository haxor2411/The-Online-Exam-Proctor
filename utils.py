...
f_name_directory = 'D:/DEACON/The-Online-Exam-Proctor/static/OutputAudios'
# Capture
cap = None
...
def reduceBitRate (input_file,output_file):
   ...
   ffmpeg_path = "D:/ffmpeg-2024-05-08-git-e8e84dc325-full_build/ffmpeg-2024-05-08-git-e8e84dc325-full_build/bin/ffmpeg.exe"  # Replace with the actual path to ffmpeg.exe on your system
...
def deleteTrashVideos():
    global video
    video_folder = 'D:/DEACON/The-Online-Exam-Proctor/static/Videos'
