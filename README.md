...
## Getting Started
- First, you need to clone the repo: `https://github.com/haxor2411/The-Online-Exam-Proctor.git`
- Run the `requirement.txt` file for the installation.
- Run the `app.py` file.



_**Note:**_ You can read the project details [here](https://github.com/haxor2411/The-Online-Exam-Proctor/blob/main/Report.pdf).
